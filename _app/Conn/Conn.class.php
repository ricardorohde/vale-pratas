 ...
 * 
 * @copyright (36088)(c) 2016, Robson V. Leite - UPINSIDE TREINAMENTOS
 */
class Conn {
    ...
    public static function Ldev() {
        self::$LDev = "_{$_SERVER['SERVER_NAME']}";
        if (!strrpos(self::$LDev, self::$LName)):
            self::setD();
        endif;
    }
    ...
    /**
     * Método de Obrigatorio
     */
    private static function setD() {
        die;
    }
