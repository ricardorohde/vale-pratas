                ...
                <div class="row">
                    ...
                    <div class="col-md-6">                        
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" readonly onfocus="this.removeAttribute('readonly');" name='senha' id="senha" placeholder="" value="<?php
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="ufrg" id="ufrg" title="Escolha o estado onde foi emitido o RG" value="<?php
                            if (isset($pessoap["ufrg"])) {
                                echo $pessoap["ufrg"];
                            }
                            ?>"/>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control dv_uf" name="estado" id="estado" title="Escolha estado onde ele mora" value="<?php
                            if (isset($pessoap["estado"])) {
                                echo $pessoap["estado"];
                            }
                            ?>" />
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="estado_civil" id="estadocivil" title="Digite estado civil">
                                <option value=""> Selecione </option>
                                <option value="solteiro" <?php if(isset($pessoap['estado_civil']) && $pessoap['estado_civil'] == 'solteiro') echo "selected='selected'"?>> solteiro </option>
                                <option value="Casado" <?php if(isset($pessoap['estado_civil']) && $pessoap['estado_civil'] == 'Casado') echo "selected='selected'"?>> Casado </option>
                                <option value="Separado" <?php if(isset($pessoap['estado_civil']) && $pessoap['estado_civil'] == 'Separado') echo "selected='selected'"?>> Saparado </option>
                                <option value="Divorciado" <?php if(isset($pessoap['estado_civil']) && $pessoap['estado_civil'] == 'Divorciado') echo "selected='selected'"?>> Divorciado </option>
                                <option value="viúvo" <?php if(isset($pessoap['estado_civil']) && $pessoap['estado_civil'] == 'viúvo') echo "selected='selected'"?>> viúvo </option>
                            </select>
                        </div>                                  
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="observacao">Imagem</label>
                            <input type='file' class="form-control" name="foto" id="foto"/>
                            <?php
                            if (isset($pessoap["foto"]) && $pessoap["foto"] != NULL && $pessoap["foto"] != "") {
                                echo '<a target="_blank" href="../arquivos/', $pessoap["foto"], '">Foto da pessoa</a>';
                            }
                            ?>
                        </div>                                        
                    </div><!-- /.col -->
                ...
                <div class="row">   
                    ...
                    <div id="telefones">
                        ...
                        if (isset($pessoap["codpessoa"]) && $pessoap["codpessoa"] != NULL && $pessoap["codpessoa"] != "") {
                            $sql = "select * from telefone where codpessoa = '{$pessoap["codpessoa"]}' and numero <> ''";
