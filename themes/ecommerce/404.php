    ...
    <div class="content">
        <section>
            <header class="header">
                ...
                <p>A página ou conteúdo acessado não foi encotado em nosso site. Sentimos muito por isso! Por favor. Faça uma pesquisa, ou ainda veja abaixo uma lista de nossos produtos mais vendidos!</p>
            </header>
