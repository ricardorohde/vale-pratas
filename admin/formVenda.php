<div class="row">
    <div class="box box-default">
        ...
        <div class="box-body">
            <div class="row">
                <form action="../control/ProcurarVendaRelatorio.php" id="fpvenda" name="fpvenda" method="post">
                    <input type="hidden" name="codvenda" id="codvendaTipo" value=""/>
                    <div class="col-md-6">                        
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input title="preencha para dar desconto no venda" type='text' class="form-control real" name="desconto" id="descontoTipoProduto" maxlength="8" placeholder="Digite desconto" value=''>
                        </div>
                    </div>                    
                    <div class="col-md-12">
                        <div class="form-group">
            ...
            <div class="row">
                <div id="listagemVenda" class="col-md-12"></div>
            </div>
        </div>
    </div>
    <!--/.col (right) -->
