...
if (isset($_GET["codproduto"]) && $_GET["codproduto"] != NULL && trim($_GET["codproduto"]) != "") {
    $sql = "select *
        from produto where codproduto = '{$_GET["codproduto"]}' $andProduto";
    $produtop = $conexao->comandoArray($sql);

    $action = "../control/SalvarProduto.php";
} else {
    $action = "../control/SalvarProduto.php";
}
?>  
...
<html lang="pt-br">
    ...
    <body class="hold-transition skin-blue sidebar-mini">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div id="tabs">
                        ...
                        <?php } ?>
                        <div id="tabs-3">
                            <?php include("formCategoriaProduto.php"); ?>
                        </div>
                        <div id="tabs-4">
                            <?php include("formTipoProduto.php"); ?>
                        </div>
        ...
        <script type="text/javascript" src="./recursos/js/ajax/TipoProduto.js"></script>
...
function reestruturandoTelefone($telefoneproduto2) {
    $telefone = str_replace("-", "", str_replace("(", "", str_replace(")", "", str_replace('.', '', $telefoneproduto2))));
    $telefoneproduto = trim($telefone);
    if (strlen($telefoneproduto) == 10) {
        $mascaraTelefone = "(##)####-####";
    } else {
        $mascaraTelefone = "(##)#####-####";
    }
    if (strlen($telefoneproduto) > 8 && $telefoneproduto{0} == "0") {
        $ddd = substr($telefoneproduto, 0, 3);
        if ($ddd !== "021") {
            $telefone = mask($telefoneproduto, $mascaraTelefone);
        } else {
            $telefone = mask($telefoneproduto, $mascaraTelefone);
        }
    } elseif (strlen($telefoneproduto) > 8 && $telefoneproduto{0} != "0") {
        $ddd = substr($telefoneproduto, 0, 2);
        if ($ddd !== "21") {
            $telefone = mask($telefoneproduto, $mascaraTelefone);
        } else {
            $telefone = mask($telefoneproduto, $mascaraTelefone);
        }
    } elseif (strlen($telefoneproduto) == 8) {
        $telefone = mask("21" . $telefoneproduto, $mascaraTelefone);
    }
    return $telefone;
}
