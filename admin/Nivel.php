...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <script type="text/javascript" src="./recursos/js/ajax/Nivel.js"></script>
        <script type="text/javascript" src="./recursos/js/ajax/Modulo.js"></script>
        <script type="text/javascript" src="./recursos/js/ajax/Pagina.js"></script>
