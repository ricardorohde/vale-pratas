                    ...
                    <div class="row">
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-aqua">
                                <div class="inner">
                                    <?php
                                        $qtdVenda = $conexao->comandoArray('select count(1) as qtd from venda where codstatus = 1');
                                    ?>
                                    <h3><?=$qtdVenda["qtd"]?></h3>
                                    <p>Novas Vendas</p>
                                </div>
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-red">
                                <div class="inner">
                                    <?php
                                    $qtdVisitante = $conexao->comandoArray('select count(1) as qtd from visitante');
                                    ?>
                                    <h3><?=$qtdVisitante["qtd"]?></h3>
                                    <p>Visitantes site</p>
                                </div>
                                <div class="icon">
