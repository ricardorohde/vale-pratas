...
function reestruturandoTelefone($telefonebanner2) {
    $telefone = str_replace("-", "", str_replace("(", "", str_replace(")", "", str_replace('.', '', $telefonebanner2))));
    $telefonebanner = trim($telefone);
    if (strlen($telefonebanner) == 10) {
        $mascaraTelefone = "(##)####-####";
    } else {
        $mascaraTelefone = "(##)#####-####";
    }
    if (strlen($telefonebanner) > 8 && $telefonebanner{0} == "0") {
        $ddd = substr($telefonebanner, 0, 3);
        if ($ddd !== "021") {
            $telefone = mask($telefonebanner, $mascaraTelefone);
        } else {
            $telefone = mask($telefonebanner, $mascaraTelefone);
        }
    } elseif (strlen($telefonebanner) > 8 && $telefonebanner{0} != "0") {
        $ddd = substr($telefonebanner, 0, 2);
        if ($ddd !== "21") {
            $telefone = mask($telefonebanner, $mascaraTelefone);
        } else {
            $telefone = mask($telefonebanner, $mascaraTelefone);
        }
    } elseif (strlen($telefonebanner) == 8) {
        $telefone = mask("21" . $telefonebanner, $mascaraTelefone);
    }
    return $telefone;
}
